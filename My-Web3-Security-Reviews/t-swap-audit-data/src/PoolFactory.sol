...
contract PoolFactory {
    ...
    //@audit-info: This error message has not been used.
    ...
    /*//////////////////////////////////////////////////////////////
                               FUNCTIONS
    //////////////////////////////////////////////////////////////*/
    //@audit: lacks a zero check for `wethToken`
    ...
    //@audi: The param `tokenAddress` lacks a zero check. 
    function createPool(address tokenAddress) external returns (address) {
        if (s_pools[tokenAddress] != address(0)) {
            revert PoolFactory__PoolAlreadyExists(tokenAddress);
        }
        string memory liquidityTokenName = string.concat("T-Swap ", IERC20(tokenAddress).name());
        //@auidt-info: This should IERC20(tokenAddress).symbol() instead of IERC20(tokenAddress).name()
