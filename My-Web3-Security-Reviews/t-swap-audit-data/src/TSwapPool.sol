...
contract TSwapPool is ERC20 {
    ...
    function deposit(
        ...
        //audit--High: The deadline param has not been implemented or used that means
        //anyone can deposit liquidity here even though the deadline has not passed.
        ...
        returns (uint256 liquidityTokensToMint)
    {
        ...
        if (totalLiquidityTokenSupply() > 0) {
            ...
            //audit-info: This line of code is not needed as the poolTokenReserves is not used anywhere.
            ...
            //audit-info: It is reccomended to update any variable before making an external call so it will be better to move it above 
            //`_addLiquidityMintAndTransfer`
    ...
    {
        //audit-high: Users are charged way too much fees here. The fee should be 0.3% not 0.3% * 997
        //audit-info: Magic Numbers are used here. It is reccomended to use constants instead of magic numbers.
        return
    ...
    function swapExactInput(
        ...
        revertIfZero(inputAmount)
        revertIfDeadlinePassed(deadline)
        //@audit-low: protocol giving wrong return 
        returns (uint256 output)
    {
        ...
        //@audit-info: what if the output amount will be more than the liquidity pool has?
    ...
    //@audit-high: No sliippage protetion. it may force the user to pay more than what he wants to pay.
    ...
    function sellPoolTokens(
        ...
        //@audit this is wrong!
        //swapExactInput should have been used here.
        return
            swapExactOutput(
                i_poolToken,
                i_wethToken,
     ...
     */
    //@audit: By giving the caller an extra token every 10 swaps, we are breaking the invraiant of the pool that x*y = k
    function _swap(
        IERC20 inputToken,
        uint256 inputAmount,
        IERC20 outputToken,
