...
<body bgcolor="#000000">
	...
	<div style=" margin-top:70px;color:#FFF; font-size:23px; text-align:center">Welcome&nbsp;&nbsp;&nbsp;<font color="#FF0000"> DVLabs </font><br>
		<font size="5" color="#00FF00">
			<?php
			//including the Mysql connect parameters.
			include("../../connections/mysqli-connect.php");

			function check_quotes($con, $string)
			{
